...
int main() {
    // Box
    filesystem::path inputDir("/home/haoyan/GAMES202/homework5/examples/box/input");
    filesystem::path outputDir("/home/haoyan/GAMES202/homework5/examples/box/output");
    int frameNum = 20;
